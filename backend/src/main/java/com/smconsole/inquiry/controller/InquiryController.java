package com.smconsole.inquiry.controller;

import com.smconsole.inquiry.dto.*;
import com.smconsole.inquiry.enums.InquiryStatus;
import com.smconsole.inquiry.enums.InquiryType;
import com.smconsole.inquiry.service.InquiryService;
...
public class InquiryController {
    ...
    public ResponseEntity<InquiryCommentResponse> createComment(
            @PathVariable Long id, @RequestBody InquiryCommentRequest request) {
    ...
    public ResponseEntity<InquiryResponse> updateStatus(
            @PathVariable Long id, @RequestBody InquiryStatusRequest request) {
